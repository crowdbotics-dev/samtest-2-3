"""
Django settings for samtest_2_3 project.
...
WSGI_APPLICATION = 'samtest_2_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samtest_2_3 API",
    "DESCRIPTION": "API documentation for samtest_2_3 App",
    "VERSION": "v1",
}
